...
<div id="working_area">
	...
	<div id="fieldset">
		<fieldset>
			<legend class="black12"><strong>Search Applicants Details</strong></legend>
			
<div>
<form action="dbbl_details.php" method="post">
	<table class="Taable" id="login">
			
		<tr>
		  <td><p><strong>Applicantion Id:</strong></p></td></tr>
			
			<tr><td><strong>
		    <input name="app_id" id="app_id" text>
</strong></td></tr><br>
			...
			<td>
			<strong>
		    <input name="gender" type="text" id="gender" text>
			</strong>
			</td>
			</tr>
        ...
        <br>        <br>
		      <input type="reset" name="reset" id="reset" value="Reset" accesskey="c">
		    </strong></p></td></tr>
	</table>
</form> 
</div>
